...
namespace SkyrimShop.Controllers
{
    public class ItemAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ItemID,ItemName,ItemType,ItemPrice,ItemDescription,ItemClass")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ItemID,ItemName,ItemType,ItemPrice,ItemDescription,ItemClass")] Item item)
        {
            if (ModelState.IsValid)
            {
